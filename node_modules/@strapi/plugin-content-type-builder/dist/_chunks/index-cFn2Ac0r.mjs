...
const ListView$1 = lazy(() => import("./ListView-h1m2OOot.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-h1m2OOot.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-cFn2Ac0r.mjs.map

...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      async Component() {
        const component = await import("./index-cFn2Ac0r.mjs").then((n) => n.i);
        return component;
      }
    });
    app.registerPlugin({
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/ar.json": () => import("./ar-pygLrP3N.mjs"), "./translations/cs.json": () => import("./cs-2Bc9XvQu.mjs"), "./translations/de.json": () => import("./de-HKLarGVE.mjs"), "./translations/dk.json": () => import("./dk-vU8pVwk2.mjs"), "./translations/en.json": () => import("./en-RZZgM9yt.mjs"), "./translations/es.json": () => import("./es-AZ2pHBh3.mjs"), "./translations/fr.json": () => import("./fr-g6EMGhCD.mjs"), "./translations/id.json": () => import("./id-E984zalv.mjs"), "./translations/it.json": () => import("./it-iRM7TNTY.mjs"), "./translations/ja.json": () => import("./ja-yh0nzpcN.mjs"), "./translations/ko.json": () => import("./ko-lT33hd2D.mjs"), "./translations/ms.json": () => import("./ms-MiLXNCjS.mjs"), "./translations/nl.json": () => import("./nl-dn3A0wMn.mjs"), "./translations/pl.json": () => import("./pl-e8n-TFCx.mjs"), "./translations/pt-BR.json": () => import("./pt-BR-0wPXJgdL.mjs"), "./translations/pt.json": () => import("./pt-VtuofvU-.mjs"), "./translations/ru.json": () => import("./ru-G4uBA60G.mjs"), "./translations/sk.json": () => import("./sk-2xTTsRUl.mjs"), "./translations/sv.json": () => import("./sv--p6t_RM5.mjs"), "./translations/th.json": () => import("./th-JcSZNDPL.mjs"), "./translations/tr.json": () => import("./tr-TeKzlN_q.mjs"), "./translations/uk.json": () => import("./uk-wS6hV3Qo.mjs"), "./translations/zh-Hans.json": () => import("./zh-Hans-H7FTqsRJ.mjs"), "./translations/zh.json": () => import("./zh-ZGIQhAiL.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-dwMGUDbN.mjs.map

...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-HlYyct1k.js")).then((n) => n.index);
        return component;
      }
    });
    app.registerPlugin({
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/ar.json": () => Promise.resolve().then(() => require("./ar-pTS_ui2o.js")), "./translations/cs.json": () => Promise.resolve().then(() => require("./cs-EOdL_30j.js")), "./translations/de.json": () => Promise.resolve().then(() => require("./de-fwGSeFCl.js")), "./translations/dk.json": () => Promise.resolve().then(() => require("./dk-a_pfqJk6.js")), "./translations/en.json": () => Promise.resolve().then(() => require("./en-zI-ijEea.js")), "./translations/es.json": () => Promise.resolve().then(() => require("./es-o1tohxeQ.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-6-6tW_vZ.js")), "./translations/id.json": () => Promise.resolve().then(() => require("./id-sUfBMFVz.js")), "./translations/it.json": () => Promise.resolve().then(() => require("./it-GMHtL-ej.js")), "./translations/ja.json": () => Promise.resolve().then(() => require("./ja-OazXOwEv.js")), "./translations/ko.json": () => Promise.resolve().then(() => require("./ko-FYNnTLJ-.js")), "./translations/ms.json": () => Promise.resolve().then(() => require("./ms-Q65hGPek.js")), "./translations/nl.json": () => Promise.resolve().then(() => require("./nl-uEIWLAe0.js")), "./translations/pl.json": () => Promise.resolve().then(() => require("./pl-2qSNjRjP.js")), "./translations/pt-BR.json": () => Promise.resolve().then(() => require("./pt-BR-9S1x1LPt.js")), "./translations/pt.json": () => Promise.resolve().then(() => require("./pt-Bq_LFyiU.js")), "./translations/ru.json": () => Promise.resolve().then(() => require("./ru-uXDXOOp3.js")), "./translations/sk.json": () => Promise.resolve().then(() => require("./sk--Lelf-9o.js")), "./translations/sv.json": () => Promise.resolve().then(() => require("./sv-uj9Nm_NZ.js")), "./translations/th.json": () => Promise.resolve().then(() => require("./th-G4KY_WyU.js")), "./translations/tr.json": () => Promise.resolve().then(() => require("./tr-REvrr85g.js")), "./translations/uk.json": () => Promise.resolve().then(() => require("./uk-Ad5Het5l.js")), "./translations/zh-Hans.json": () => Promise.resolve().then(() => require("./zh-Hans-bjJz6vOD.js")), "./translations/zh.json": () => Promise.resolve().then(() => require("./zh-jTxHJoG4.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-thLIfVlN.js.map

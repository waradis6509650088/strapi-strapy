...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-5QcYoU4B.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-EnbZEVuW.js"));
        return component;
      },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/ca.json": () => Promise.resolve().then(() => require("./ca-imVqek0x.js")), "./translations/de.json": () => Promise.resolve().then(() => require("./de-fP4-hhq-.js")), "./translations/dk.json": () => Promise.resolve().then(() => require("./dk-8lbP49ay.js")), "./translations/en.json": () => Promise.resolve().then(() => require("./en-R82Cu35C.js")), "./translations/es.json": () => Promise.resolve().then(() => require("./es-YXHk_Wlv.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-pAKFFlwT.js")), "./translations/he.json": () => Promise.resolve().then(() => require("./he-AvpiGKKI.js")), "./translations/it.json": () => Promise.resolve().then(() => require("./it-qu_coGlH.js")), "./translations/ja.json": () => Promise.resolve().then(() => require("./ja-4VuBaARB.js")), "./translations/ko.json": () => Promise.resolve().then(() => require("./ko-bjFoHjO4.js")), "./translations/ms.json": () => Promise.resolve().then(() => require("./ms-KfLhVMjy.js")), "./translations/pl.json": () => Promise.resolve().then(() => require("./pl-ju4SV4by.js")), "./translations/pt-BR.json": () => Promise.resolve().then(() => require("./pt-BR-HmKv7028.js")), "./translations/pt.json": () => Promise.resolve().then(() => require("./pt-fUhNhioU.js")), "./translations/ru.json": () => Promise.resolve().then(() => require("./ru-uXLNlj_s.js")), "./translations/sk.json": () => Promise.resolve().then(() => require("./sk-JZqURLfh.js")), "./translations/th.json": () => Promise.resolve().then(() => require("./th-BWS-N8ww.js")), "./translations/tr.json": () => Promise.resolve().then(() => require("./tr-pttps3Ln.js")), "./translations/uk.json": () => Promise.resolve().then(() => require("./uk-B96sC1Jn.js")), "./translations/zh-Hans.json": () => Promise.resolve().then(() => require("./zh-Hans-AXNL7cW9.js")), "./translations/zh.json": () => Promise.resolve().then(() => require("./zh-0uDeeGsg.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-pGz8fFIa.js.map

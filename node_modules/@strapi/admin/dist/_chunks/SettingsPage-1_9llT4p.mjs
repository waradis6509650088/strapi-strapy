...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-NCt4-R5U.mjs";
import sortBy from "lodash/sortBy";
import { useSelector } from "react-redux";
import { s as selectAdminPermissions } from "./AuthenticatedApp-GC9sytrp.mjs";
import { SubNav, SubNavHeader, SubNavSections, SubNavSection, SubNavLink } from "@strapi/design-system/v2";
import { Lightning, Plus, Refresh, PicturePlus, Check, ExternalLink } from "@strapi/icons";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-fE09nQBQ.mjs")).SETTINGS_LINKS_EE(),
    {
      ...
      return /* @__PURE__ */ jsxs(
        SubNavLink,
        {
          ...
          children: [
            ...
            link?.lockIcon && /* @__PURE__ */ jsx(CustomIcon, { width: `${15 / 16}rem`, height: `${15 / 16}rem`, as: Lightning })
          ]
        },
        link.id
      );
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-uxhmCvLZ.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-qUzcFRYT.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-vI7rOpa-.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-EzG3R8c_.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-m7pa1w4V.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-DHFcFptO.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-fi71U2Y3.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-lscBKMe6.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-lhQnnSMZ.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-8BeRt60a.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-46wAt5pF.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-X9V7eD4E.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-AnpNYGS-.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-nAZrTRIE.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-B8EsgOqz.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-hHgAMYki.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-1_9llT4p.mjs.map

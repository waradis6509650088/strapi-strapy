...
import { RemoveRoundedButton, pxToRem, Form, CheckPagePermissions, useNotification, useAPIErrorHandler, LoadingIndicatorPage, SettingsPageTitle } from "@strapi/helper-plugin";
import { NavLink, useRouteMatch, useHistory } from "react-router-dom";
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-NCt4-R5U.mjs";
...
import { u as useWebhooks } from "./useWebhooks-vTIGfLb3.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-GglsD7N7.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-fi71U2Y3.mjs.map

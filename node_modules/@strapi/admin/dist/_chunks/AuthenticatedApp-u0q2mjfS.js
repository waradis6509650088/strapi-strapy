...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.7",
  "@strapi/provider-audit-logs-local": "4.25.7",
  "@strapi/types": "4.25.7",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.7",
  "@strapi/data-transfer": "4.25.7",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.25.7",
...
`;
const BadgeIcon = styled__default.default(designSystem.Icon)`
  &&& {
    path {
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const {
    logos: { menu }
  } = index.useConfiguration("LeftMenu");
            ...
            return /* @__PURE__ */ jsxRuntime.jsx(NavLinkWrapper, { children: /* @__PURE__ */ jsxRuntime.jsx(
              v2.NavLink,
              {
                ...
                badgeContent: (
                  ...
                  link?.lockIcon ? /* @__PURE__ */ jsxRuntime.jsx(
                    BadgeIcon,
                    {
                      width: `${15 / 16}rem`,
                      height: `${15 / 16}rem`,
      ...
      userLinksVisible && /* @__PURE__ */ jsxRuntime.jsx(
        LinkUserWrapper,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.FocusTrap, { onEscape: handleToggleUserLinks, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 0, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(LinkUser, { tabIndex: 0, onClick: logout, to: "/auth/login", children: [
...
const selectAdminPermissions = index.createTypedSelector((state) => state.admin_app.permissions);
const useMenu = () => {
...
const CM = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-hLwLJn2b.js")).then((n) => n.App).then((mod) => ({ default: mod.App }))
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-zgM7JhID.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-eCEcrw7N.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-JTtXw3Vz.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-hLwLJn2b.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-nWh5usVZ.js")).then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./SettingsPage-DMfiUNsO.js")).then((mod) => ({
...
const Admin = () => {
  ...
  const { menu } = helperPlugin.useStrapiApp();
  const { showTutorials } = index.useConfiguration("Admin");
  index.useOnce(() => {
...
const AuthenticatedApp = () => {
  ...
  const { showReleaseNotification } = index.useConfiguration("AuthenticatedApp");
  const { data: appInfo, isLoading: isLoadingAppInfo } = index.useInformationQuery();
  const {
    data: permissions,
    isLoading: isLoadingPermissions,
    refetch
  } = index.useGetMyPermissionsQuery();
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    helperPlugin.AppInfoProvider,
    {
      ...
      userDisplayName,
      children: /* @__PURE__ */ jsxRuntime.jsxs(index.RBACProvider, { permissions: permissions ?? [], refetchPermissions, children: [
...
//# sourceMappingURL=AuthenticatedApp-u0q2mjfS.js.map
